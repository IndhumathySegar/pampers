...
@Component({
  selector: "kt-new-locale-history",
  templateUrl: "./new-locale-history.component.html",
  styleUrls: ["./new-locale-history.component.scss"],
  animations: [
...
export class NewLocaleHistory implements OnInit {
  ...
  getHistory() {
    ...
    const contentfulServiceSubs = this.contentfulService
      .listNewLocaleHistory(pageParams)
      .subscribe((res: any) => {
