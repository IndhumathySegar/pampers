  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  setHeader(headerEl, headerMb, subHeader): number {
    let height = 0;
    // mobile header
    if (window.getComputedStyle(headerEl).height === "0px") {
      height += headerMb.offsetHeight;
    } else {
      // desktop header
